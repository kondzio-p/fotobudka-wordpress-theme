    ...
    if (function_exists('acf_add_local_field_group')) {
        ...
        acf_add_local_field_group(array(
            ...
            'fields' => array(
                // Sekcja: Nagłówki
                array(
                    'key' => 'field_naglowki_tab',
                    'label' => 'NAGŁÓWKI I TYTUŁY SEKCJI',
                    'type' => 'tab',
                ),
                array(
                    ...
                    'instructions' => 'Główny tytuł wyświetlany na stronie. Można używać HTML.',
                ),
                array(
                    ...
                    'instructions' => 'Podtytuł pod głównym tytułem.',
                ),
                array(
                    'key' => 'field_tytul_oferta',
                    'label' => 'Tytuł sekcji "Nasza oferta"',
                    'name' => 'tytul_oferta',
                    'type' => 'text',
                    'default_value' => 'Nasza <span style="color: #801039">oferta</span>',
                    'instructions' => 'Tytuł sekcji z ofertą. Można używać HTML do kolorowania.',
                ),
                array(
                    'key' => 'field_tytul_statystyki',
                    'label' => 'Tytuł sekcji "My w liczbach"',
                    'name' => 'tytul_statystyki',
                    'type' => 'text',
                    'default_value' => '<span style="color: #801039">My</span> w liczbach',
                    'instructions' => 'Tytuł sekcji ze statystykami. Można używać HTML.',
                ),
                array(
                    'key' => 'field_tytul_galeria',
                    'label' => 'Tytuł sekcji "Nasza galeria"',
                    'name' => 'tytul_galeria',
                    'type' => 'text',
                    'default_value' => 'Nasza <span style="color: #801039">galeria</span>',
                    'instructions' => 'Tytuł sekcji z galerią. Można używać HTML.',
                ),
                // Sekcja: Statystyki
                array(
                    'key' => 'field_statystyki_tab',
                    'label' => 'STATYSTYKI "MY W LICZBACH"',
                    'type' => 'tab',
                ),
                array(
                    'key' => 'field_stat1_liczba',
                    'label' => 'Statystyka 1 - Liczba',
                    'name' => 'stat1_liczba',
                    'type' => 'text',
                    'default_value' => '0+',
                    'instructions' => 'Pierwsza statystyka (np. "100+", "500", "∞")',
                ),
                array(
                    'key' => 'field_stat1_opis',
                    'label' => 'Statystyka 1 - Opis',
                    'name' => 'stat1_opis',
                    'type' => 'text',
                    'default_value' => 'zadowolonych klientów',
                    'instructions' => 'Opis pierwszej statystyki',
                ),
                array(
                    'key' => 'field_stat2_liczba',
                    'label' => 'Statystyka 2 - Liczba',
                    'name' => 'stat2_liczba',
                    'type' => 'text',
                    'default_value' => '0 lat',
                    'instructions' => 'Druga statystyka',
                ),
                array(
                    'key' => 'field_stat2_opis',
                    'label' => 'Statystyka 2 - Opis',
                    'name' => 'stat2_opis',
                    'type' => 'text',
                    'default_value' => 'na rynku',
                ),
                array(
                    'key' => 'field_stat3_liczba',
                    'label' => 'Statystyka 3 - Liczba',
                    'name' => 'stat3_liczba',
                    'type' => 'text',
                    'default_value' => '∞',
                    'instructions' => 'Trzecia statystyka',
                ),
                array(
                    'key' => 'field_stat3_opis',
                    'label' => 'Statystyka 3 - Opis',
                    'name' => 'stat3_opis',
                    'type' => 'text',
                    'default_value' => 'uśmiechów',
                ),
                // Sekcja: Tytuły ofert
                array(
                    'key' => 'field_oferty_tytuly_tab',
                    'label' => 'TYTUŁY KART OFERT',
                    'type' => 'tab',
                ),
                array(
                    'key' => 'field_oferta_360_tytul',
                    'label' => 'Tytuł Fotobudki 360',
                    'name' => 'oferta_360_tytul',
                    'type' => 'text',
                    'default_value' => 'Fotobudka 360',
                    'instructions' => 'Nazwa wyświetlana na karcie oferty',
                ),
                array(
                    'key' => 'field_oferta_mirror_tytul',
                    'label' => 'Tytuł Fotolustra',
                    'name' => 'oferta_mirror_tytul',
                    'type' => 'text',
                    'default_value' => 'Fotolustro',
                ),
                array(
                    'key' => 'field_oferta_smoke_tytul',
                    'label' => 'Tytuł Ciężkiego dymu',
                    'name' => 'oferta_smoke_tytul',
                    'type' => 'text',
                    'default_value' => 'Ciężki dym',
                ),
                array(
                    'key' => 'field_oferta_fountain_tytul',
                    'label' => 'Tytuł Fontann iskier',
                    'name' => 'oferta_fountain_tytul',
                    'type' => 'text',
                    'default_value' => 'Fontanny iskier',
                ),
                array(
                    'key' => 'field_oferta_neons_tytul',
                    'label' => 'Tytuł Neonowych napisów',
                    'name' => 'oferta_neons_tytul',
                    'type' => 'text',
                    'default_value' => 'Neonowe napisy',
                ),
                // Sekcja: Opisy ofert
                array(
                    'key' => 'field_oferty_opisy_tab',
                    'label' => 'OPISY KART OFERT',
                    'type' => 'tab',
                ),
                array(
                ...
                // Sekcja: Kontakt
                array(
                    'key' => 'field_kontakt_tab',
                    'label' => 'KONTAKT I MEDIA SPOŁECZNOŚCIOWE',
                    'type' => 'tab',
                ),
                array(
                    'key' => 'field_telefon',
                    ...
                    'instructions' => 'Numer telefonu wyświetlany w stopce',
                ),
                array(
                    'key' => 'field_footer_tytul',
                    'label' => 'Tytuł sekcji kontakt',
                    'name' => 'footer_tytul',
                    'type' => 'text',
                    'default_value' => 'Dotrzyj do nas za pomocą',
                    'instructions' => 'Nagłówek sekcji kontaktowej w stopce',
                ),
                array(
                ...
                array(
                    'key' => 'field_facebook_handle',
                    'label' => 'Nazwa profilu Facebook',
                    'name' => 'facebook_handle',
                    'type' => 'text',
                    'default_value' => '@OG Eventspot',
                    'instructions' => 'Tekst wyświetlany przy linku Facebook',
                ),
                array(
                ...
                array(
                    ...
                    'label' => 'Nazwa profilu Instagram',
                    'name' => 'instagram_handle',
                    'type' => 'text',
                    'default_value' => '@og.eventspot',
                    'instructions' => 'Tekst wyświetlany przy linku Instagram',
                ),
            ),
            'location' => array(
                array(
